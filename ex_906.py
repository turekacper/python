...
class IceCreamStand(Restaurant):
    ...
    def get_custom_flavors(self):
        print(f"give me the propositions of the flavors you would like to see in restaruant {self.restaurant_name}: ")
        arr = []
        i= 1
        while True:
    ...
    def flavors(self):
        print(f"the flavors of ice cream available in restaurant {self.restaurant_name} are: ")
